...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    var curConfig = {
      ...
      initOpacity: 1,
      imgPath: 'method-draw/images/',
      extPath: 'method-draw/extensions/',
      jGraduatePath: 'method-draw/lib/jgraduate/images/',
      extensions: [],
      initTool: 'select',
      wireframe: false,
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
      ...
      setTimeout(function() {
        svgCanvas.embedImage(default_img_url, function(datauri) {
          if(!datauri) {
            // Disable option
